...
if (isset($_SESSION['adminEmail'])) {
    ...
    $sql = "SELECT firstname, lastname, email, permanentaddress, secondaryaddress, city, image, country, registrationdate, gender, countrycode, phone FROM adminreg WHERE email = '$email'";
        ...
        if (
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                echo '<script>
                        ...
                        setTimeout(function() {
                        window.location.href = "adminMyProfile.php"; // Redirect after 2 seconds
    ...
    <div class="container d-flex flex-column align-items-center">
        <div class="container d-flex flex-column align-items-center">
            <div class="d-flex">
                ...
                <a href="admIndex.php"><i style="float: left; margin-left: 100px; margin-top: 20px" class="fa-solid fa-x fa-5"></i></a>
            </div>
        ...
        <form action="adminMyProfile.php" method="post">
            <div class="d-flex flex-row mb-5">
                <div class="me-4">
                    ...
                    <input type="text" id="firstName" name="firstName" value="<?php echo isset($firstName) ? $firstName : ''; ?>" required pattern="[A-Za-z]+" title="Please enter letters only for the first name.">
                </div>
                <div class="me-4">
                    <label for="lastName">Last Name:</label> <br>
                    <input type="text" id="lastName" name="lastName" value="<?php echo isset($lastName) ? $lastName : ''; ?>" required pattern="[A-Za-z]+" title="Please enter letters only for the last name.">
                </div>
                <div class="me-4">
