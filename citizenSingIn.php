        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            <div class="row jumbotron box8">
                <div class="col-sm-12 mx-t3 mb-4">
                    <h2 class="text-center text-info">Citizen Login</h2>
                </div>
                ...
                <div class="col-sm-12 form-group mb-0 login_button">
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        $sql_fetch_password = "SELECT password FROM citizenreg WHERE email = '$email'";
                        ...
                        if ($result_password->num_rows > 0) {
                            ...
                            if (password_verify($enteredPassword, $hashedPasswordFromDB)) {
                                session_start();
                                $_SESSION['citizenEmail'] = $email;

                                // Fetch the firstname associated with the provided email
                                $sql_fetch_firstname = "SELECT firstname FROM citizenreg WHERE email = '$email'";
                                ...
                                header("Location: ctzIndex.php"); // Redirect to the appropriate URL
